import sys
from PyQt5.QtWidgets import QApplication, QMainWindow, QLabel, QGridLayout, QLineEdit, QPushButton, QFileDialog, QHBoxLayout, QWidget, QListWidget
from datetime import datetime

class ObjectCreator(QMainWindow):
    def __init__(self):
        super().__init__()
        self.initUI()
        self.resize(800, 300)
